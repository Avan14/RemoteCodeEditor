  ...
  return (
    <div className="w-full  py-16 px-4">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden shadow-2xl">
          ...
          <div className="bg-gray-800 flex items-center justify-between px-4 py-3 border-b border-gray-700">
            <div className="flex items-center">
              <div className="text-white text-xl font-semibold mr-4">CodePule</div>
            </div>
            <div>
          ...
          <div className="flex">
            ...
            <div className="flex-1 bg-gray-900">
              <div className="flex">
                ...
                <div className="p-4 font-mono text-sm text-gray-300 flex-grow">
                  {typingEffect}
                </div>
              </div>
            </div>
        ...
        {/* Chat Window */}
        <div className={`absolute ${chatVisible ? 'bottom-0 right-0' : 'bottom-16 right-4'} transition-all duration-200`}>
          {!chatVisible && (
            <button 
              ...
              <div className="bg-white h-64 overflow-y-auto p-4">
                <div className="flex mb-4">
                  ...
                  <div className="bg-gray-100 rounded-lg py-2 px-3 max-w-xs">
                    <p className="text-gray-700 text-sm">Hello! How can I assist you today?</p>
                    <span className="text-gray-500 text-xs mt-1 block">07:55 PM</span>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-4xl mx-auto mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-gray-800 p-6 rounded-lg">
          <h3 className="text-xl font-semibold text-white mb-3">Instant Code Help</h3>
          <p className="text-gray-400">Get solutions to coding problems and debugging assistance without leaving your editor.</p>
        </div>
        
        <div className="bg-gray-800 p-6 rounded-lg">
          <h3 className="text-xl font-semibold text-white mb-3">Contextual Learning</h3>
          <p className="text-gray-400">Learn new coding concepts with explanations that understand your exact context and project.</p>
        </div>
        
        <div className="bg-gray-800 p-6 rounded-lg">
          <h3 className="text-xl font-semibold text-white mb-3">AI Code Generation</h3>
          <p className="text-gray-400">Generate boilerplate code, test cases, or entire functions based on natural language descriptions.</p>
        </div>
      </div>
    </div>
  );
